...
const DESTINATIONS = [
  ...
  { name: 'Invite staff', to: '/admin/invitations', icon: UsersIcon, roles: ['dept_head', 'dean', 'institution_admin', 'platform_admin'] },
  { name: 'Academic structure and register', to: '/admin/academic', icon: HomeIcon, roles: ['institution_admin', 'platform_admin'] },
