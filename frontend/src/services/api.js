...
export const routingService = {
  ...
  priorityPolicies: () => api.get('/routing/priority-policies').then(unwrap),
  savePriorityPolicy: (priority, data) =>
    api.put(`/routing/priority-policies/${priority}`, data).then(unwrap),
